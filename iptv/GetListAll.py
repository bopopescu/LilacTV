...
path = os.getcwd()
__base_m3u_file__ = path+"/playlist-base.m3u"
__out_m3u_file__ = path+"/update/playlist-lilactvHD"
ListNo = "1"
###################################################################################################
...
def UpdateChannelURL(m3u_file, No):
	...
	ofp = open(__out_m3u_file__+No+".m3u", 'w')
	ofp.write('#EXTM3U'+'\n')
	for line in newList:
		ofp.write(line+'\n')
	ofp.close()
