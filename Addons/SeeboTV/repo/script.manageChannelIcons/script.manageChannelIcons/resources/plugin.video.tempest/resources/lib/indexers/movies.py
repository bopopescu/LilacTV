...
class movies:
    def __init__(self):
        ...
        self.theatersOld_link = 'http://www.imdb.com/search/title?title_type=feature&num_votes=1000,&countries=us&languages=en&release_date=date[90],date[0]&sort=release_date,desc&count=40&start=1'
        ...
        self.onDeckMovies_link = 'http://api.trakt.tv/sync/playback/movies?extended=full&limit=40'
