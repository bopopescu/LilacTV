...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['dl5.lavinmovie.net']
        self.base_link_movie = 'http://dl5.lavinmovie.net/Movies/%s/'
        self.base_link_tv = 'http://dl5.lavinmovie.net/Series/%s/'
