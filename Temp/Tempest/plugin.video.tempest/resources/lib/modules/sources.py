...
# Doko'S Dupe Checker for cleaning results.
            ...
            try:
                ...
                if len(self.sources) > 0:
                    if quality in ['0']:
                        ...
                        source_720 = len([e for e in self.sources if e['quality'] == '720p' and e['debridonly'] is False])
                        ...
                        if debrid_status:
                            if quality in ['0']:
                                if not progressDialog == control.progressDialogBG:
                                    line1 = ('%s:' + '|'.join(pdiag_format)) % (string6, d_4k_label, d_1080_label, d_720_label, d_sd_label, d_total_label)
                                    line2 = ('%s:' + '|'.join(pdiag_format)) % (string7, source_4k_label, source_1080_label, source_720_label, source_sd_label, source_total_label)
                                else:
                                ...
                                if not progressDialog == control.progressDialogBG:
                                    line1 = ('%s:' + '|'.join(pdiag_format[1:])) % (string6, d_1080_label, d_720_label, d_sd_label, d_total_label)
                                    line2 = ('%s:' + '|'.join(pdiag_format[1:])) % (string7, source_1080_label, source_720_label, source_sd_label, source_total_label)
                                else:
                                ...
                                if not progressDialog == control.progressDialogBG:
                                    line1 = ('%s:' + '|'.join(pdiag_format[2:])) % (string6, d_720_label, d_sd_label, d_total_label)
                                    line2 = ('%s:' + '|'.join(pdiag_format[2:])) % (string7, source_720_label, source_sd_label, source_total_label)
                                else:
                                ...
                                if not progressDialog == control.progressDialogBG:
                                    ...
                                    line2 = ('%s:' + '|'.join(pdiag_format[3:])) % (string7, source_sd_label, source_total_label)
                                else:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.tempest.container.items'

        self.metaProperty = 'plugin.video.tempest.container.meta'
