    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            try:
                ...
                sources.append({'source': 'DL', 'quality': '1080p', 'language': 'en', 'url': final_url, 'direct': True, 'debridonly': False})
            except:
                pass
            try:
                ...
                sources.append({'source': 'DL', 'quality': '720p', 'language': 'en', 'url': final_url, 'direct': True, 'debridonly': False})
            except:
                pass
            return sources
        except:
